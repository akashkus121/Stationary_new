-- =============================================
-- Standalone Script: Add Product Stock Fields
-- Description: Adds missing stock-related columns to Products table
-- Date: 2024
-- Usage: Run this script directly in SQL Server Management Studio
-- =============================================
...
WHERE TABLE_NAME = 'Products' 
  AND COLUMN_NAME IN ('StockQuantity', 'LowStockThreshold', 'IsVisible')
